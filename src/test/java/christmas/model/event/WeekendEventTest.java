...
class WeekendEventTest {
    ...
    @Test
    void 주말_할인을_적용한다() {
        Event weekendEvent = new WeekendEvent(userDate, userOrder, eventPeriod, WEEK_EVENT_DISCOUNT);
        Assertions.assertThat(weekendEvent.benefit()).isNotZero();
    }
    ...
    void 방문_날짜가_프로모션_기간이_아니다() {
        ...
        Event weekendEvent = new WeekendEvent(userDate, userOrder, eventPeriod, WEEK_EVENT_DISCOUNT);
        Assertions.assertThat(weekendEvent.benefit()).isZero();
    }
