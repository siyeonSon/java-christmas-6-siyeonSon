...
class WeekdayEventTest {
    ...
    @Test
    void 평일_할인을_적용한다() {
        Event weekdayEvent = new WeekdayEvent(userDate, userOrder, eventPeriod, WEEK_EVENT_DISCOUNT);
        Assertions.assertThat(weekdayEvent.benefit()).isNotZero();
    }
    ...
    void 방문_날짜가_프로모션_기간이_아니다() {
        ...
        Event weekdayEvent = new WeekdayEvent(userDate, userOrder, eventPeriod, WEEK_EVENT_DISCOUNT);
        Assertions.assertThat(weekdayEvent.benefit()).isZero();
    }
